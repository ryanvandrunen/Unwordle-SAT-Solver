...
def build_theory():
    ...
    for r in range(3,-1,-1): 
        for col in range(5):
            for colour in COLOURS:
                print("colour in list:",colour)
                print("board color:", BOARD[r][col])
                print (colour == BOARD[r][col])
    ...
    for r in range(3,-1,-1):
        for col in range(5):
            for letter in ALPHABET: 
                if letter != SOL[col]: 
                    E.add_constraint(~(Letter(r,col,letter,"Green")))
    ...
    for r in range(3,-1,-1): 
        for col in range(5):
            for letter in ALPHABET: 
                for colour in COLOURS: 
                    E.add_constraint((Tile(r,col,colour))  (Letter(r,col,letter,colour)))
